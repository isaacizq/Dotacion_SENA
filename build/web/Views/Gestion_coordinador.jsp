...
<html class="wide wow-animation" lang="es">
    <head>
        ...
        %>
        <title>Gestión Coordinador</title>
    ...
    <body>
                        ...
                        <div class="rd-navbar-aside-outer">
                            <div class="rd-navbar-aside">
                                ...
                                <div class="rd-navbar-panel">
                                    ...
                                    <!-- RD Navbar Brand--><a class="rd-navbar-brand" href="../Views/Menu.jsps"><img src="../images/Logo-de-SENA-png-verde-300x300-1.png" alt="" width="151" height="44" srcset="../images/Logo-de-SENA-png-verde-300x300-1.png 2x"/></a>
                        ...
                        <div class="rd-navbar-main-outer">
                                ...
                                <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap-1">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        ...
                                        <li class="nav-item dropdown rd-nav-item ">
                                            <input class="form-control me-2" type="search" id="search" placeholder="Search" oninput="this.value = this.value.toUpperCase()"aria-label="Search">
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            <div class="mt-3 mx-2 dropdown position-absolute top-0 end-0">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><form action="Gestion_coordinador.jsp"><input class="dropdown-item" name="link" type="submit" value="Salir">
                                            <%
            ...
            <div class="table-responsive table-wrapper-scroll-y my-custom-scrollbar">
                <div class="container-fluid">
                    <table class="table table-striped-columns" id="tab">
                        <div class="row">
                            <div class="col-8">
                                <p class="mt-5 mb-3 fs-3 fw-bolder text-center mx-2 float-end" style="color: green">Coordinadores registrados</p>
                            </div>
                            <div class="col-4">
                                <button type="button" class="mt-5 mb-3 float-end fs-5 btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal11">Añadir <i class="fa-solid fa-plus"></i></button>
                            </div>
                        </div>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <%
                                CoordinadorJpaController ic = new CoordinadorJpaController();
                                List<Coordinador> lista = ic.findCoordinadorEntities();
                                for (Coordinador c : lista) {
                            %>
                            <tr>
                                <td style="text-align: center;"><%= c.getIdcoordinador()%></td>
                                ...
                                <td style="text-align: center;"><button type="submit" onclick="cargarDatosModal2('<%= c.getIdcoordinador()%>', '<%= c.getNombres()%>', '<%= c.getApellidos()%>', '<%= c.getCorreo()%>', '<%= c.getCentroIdcentro().getRegionalIdregional().getIdregional()%>', '<%= c.getCentroIdcentro().getIdcentro()%>')"><img src="../images/process_11907491.png" alt="alt"/></button></td>
                            </tr>
                            <%}%>
                        </tbody>
                    </table>
        ...
        <jsp:include page="../Componentes/modales_coordinador.jsp"></jsp:include>
        ...
        <%
                break;
            case "Actualizado_coordinador":
        %>
        <script>
            mostrarExito("Actualizado éxitoso");
        </script> <%
                break;
            case "eliminado_coordinador":
        %>
        <script>
        ...
        %>
        <script>
            mostrarError("Oops...coordinador existente!");
        </script> <%
                break;
            case "Error":
        %>

...
<%@page import="Logic.CaracterizarInstructor"%>
<%@page import="Controllers.CaracterizarInstructorJpaController"%>
...
<html class="wide wow-animation" lang="es">
    <head>
        ...
        %>
        <title>Gestión Caracterización</title>
    ...
    <body>
                            ...
                            <div class="rd-navbar-main">
                                <div class="rd-navbar-nav-wrap" id="rd-navbar-nav-wrap-1">
                                    ...
                                    <ul class="rd-navbar-nav">
                                        <li class="rd-nav-item active"><a class="rd-nav-link fs-6" href="../Views/Menu.jsp" style="color: green">Inicio</a>
                                        </li>
                                        <li class="nav-item dropdown rd-nav-item">
                                            <a class="fs-6 nav-link dropdown-toggle rd-nav-link" href="#" role="button" data-bs-toggle="dropdown" style="color: green">Registros</a>
                                            <ul class="dropdown-menu">
                                                <li><button type="button" class="fs-5 dropdown-item text-center" data-bs-toggle="modal" data-bs-target="#myModal4">Área</button></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><button type="button" class="fs-5 dropdown-item text-center" data-bs-toggle="modal" data-bs-target="#myModal2">Clima</button></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><button type="button" class="fs-5 dropdown-item text-center" data-bs-toggle="modal" data-bs-target="#myModal6">Centro</button></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><button type="button" class="fs-5 dropdown-item text-center" data-bs-toggle="modal" data-bs-target="#myModal7">Elementos</button></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><button type="button" class="fs-5 dropdown-item text-center" data-bs-toggle="modal" data-bs-target="#myModal3">Red</button></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><button type="button" class="fs-5 dropdown-item text-center" data-bs-toggle="modal" data-bs-target="#myModal5">Regional</button></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><button type="button" class="fs-5 dropdown-item text-center" data-bs-toggle="modal" data-bs-target="#myModal">Sexo</button></li>
                                            </ul>
                                        </li>

                                        <li class="nav-item dropdown rd-nav-item">
                                            <a class="fs-6 nav-link dropdown-toggle rd-nav-link" href="#" role="button" data-bs-toggle="dropdown" style="color: green">Gestión</a>
                                            <ul class="dropdown-menu">                
                                                <li><a class="fs-5 dropdown-item text-center" href="Gestion_caracterizar.jsp" target="_blank">Caracterización</a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="fs-5 dropdown-item text-center" href="Gestion_coordinador.jsp" target="_blank">Coordinadores</a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="fs-5 dropdown-item text-center" href="Gestion_clima_sexo.jsp" target="_blank">Climas y sexos</a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="fs-5 dropdown-item text-center" href="Gestion_dotacion.jsp" target="_blank">Dotaciones</a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="fs-5 dropdown-item text-center" href="Gestion_elementos.jsp" target="_blank">Elementos</a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="fs-5 dropdown-item text-center" href="Gestion_instructor.jsp" target="_blank">Instructores</a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="fs-5 dropdown-item text-center" href="Gestion_area_red.jsp" target="_blank">Redes y areas</a></li>
                                                <li><hr class="dropdown-divider"></li>
                                                <li><a class="fs-5 dropdown-item text-center" href="Gestion_regional_centro.jsp" target="_blank">Regionales y centros</a></li>
                                            </ul>
                                        </li>

                                        <li class="nav-item dropdown rd-nav-item">
                                            <a class="fs-6 nav-link dropdown-toggle rd-nav-link" href="#" role="button" data-bs-toggle="dropdown" style="color: green">Reportes</a>
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><hr class="dropdown-divider"></li>
                                                <li><button type="button" class="fs-5 dropdown-item text-center" data-bs-toggle="modal" data-bs-target="#myModal12">X Instructor</button></li>
                                            </ul>
                                        </li>
                                        <li class="nav-item dropdown rd-nav-item ">
                                            <input class="form-control me-2" type="search" id="search" oninput="this.value = this.value.toUpperCase()" placeholder="Search" aria-label="Search">
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="mt-5 table-responsive table-wrapper-scroll-y my-custom-scrollbar" style="overflow-y: scroll; max-height: 500px;">
                <div class="container-fluid">
                    <table class="table table-striped-columns" id="tabla">
                        <div class="row">
                            <div class="col-8">
                                <p class="mt-5 mb-3 fs-3 fw-bolder text-center mx-2 float-end" style="color: green">Caracterizaciones registrados</p>
                            </div>
                            <div class="col-4">
                        ...
                        <thead>
                            <tr>
                                <th scope="col" class="fw-bolder fs-5" style="text-align: center;">Id Caracterizar</th>
                                <th scope="col" class="fw-bolder fs-5" style="text-align: center;">Instructor</th>
                                ...
                                <th scope="col" class="fw-bolder fs-5" style="text-align: center;">Año</th>
                                <th scope="col" class="fw-bolder fs-5" style="text-align: center;">Descripción</th>
        ...
        <jsp:include page="../Componentes/modales_caracterizar.jsp"></jsp:include>
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (data.length === 0) {
                                    ...
                                    $('#tabla tbody').append('<tr><td colspan="3" class="text-center">No se encontraron caracterizaciones en la base de datos.</td></tr>');
                                } else {
                                    $.each(data, function (index, caracterizar) {
                                        var row = '<tr>' +
                                                '<td style="text-align: center;">' + caracterizar.id + '</td>' +
                                                '<td style="text-align: center;">' + caracterizar.nombre_instructor + '</td>' +
                                                '<td style="text-align: center;">' + caracterizar.nombre_red + '</td>' +
                                                '<td style="text-align: center;">' + caracterizar.nombre_area + '</td>' +
                                                '<td style="text-align: center;">' + caracterizar.nombre_clima + '</td>' +
                                                '<td style="text-align: center;">' + caracterizar.nombre_sexo + '</td>' +
                                                '<td style="text-align: center;">' + caracterizar.ano + '</td>' +
                                                '<td style="text-align: center;">' + caracterizar.dotacion + '</td>' +
                                                '<td style="text-align: center;">' +
                                                '<button type="button"' +
                                                'onclick="cargarDatosModal(\'' +
                                                caracterizar.id + '\', \'' + caracterizar.idinstructor + '\', \'' +
                                                caracterizar.idred + '\', \'' + caracterizar.idarea + '\', \'' +
                                                caracterizar.idclima + '\', \'' + caracterizar.idsexo + '\', \'' +
                                                caracterizar.ano + '\', \'' + '\')"><img src="../images/process_11907491.png" alt="alt"/></button>' +
                                                '</td>' +
                                                '</tr>';
